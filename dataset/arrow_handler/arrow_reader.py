...
from CLTrainingFramework.utils.naming import filenames_for_dataset_split
from .download.download_config import DownloadConfig  # noqa: F401
from CLTrainingFramework.dataset.arrow_handler.arrow_table.block_table import MemoryTable, MemoryMappedTable, Table
from CLTrainingFramework.dataset.arrow_handler.arrow_table.table import concat_tables
...
if TYPE_CHECKING:
    ...
    from CLTrainingFramework.dataset.arrow_handler.arrow_dataset.dataset_splits import SplitInfo
...
class ArrowReader(BaseReader):
    ...
    def read_table(filename, in_memory=False) -> Table:
        ...
        Returns:
            pyarrow.Table
        """
        table_cls = MemoryTable if in_memory else MemoryMappedTable
