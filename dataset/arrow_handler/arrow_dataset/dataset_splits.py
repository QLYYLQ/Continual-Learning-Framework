...
@dataclass
class SplitInfo:
    name: str = dataclasses.field(default="", metadata={"include_in_as_dict_even_if_is_default": True})
    num_bytes: int = dataclasses.field(default=0, metadata={"include_in_as_dict_even_if_is_default": True})
    num_examples: int = dataclasses.field(default=0, metadata={"include_in_as_dict_even_if_is_default": True})
    ...
    dataset_name: Optional[str] = dataclasses.field(
        default=None, metadata={"include_in_as_dict_even_if_is_default": True}
    )
...
class SplitDict(dict):
    ...
    def to_yaml_list(self) -> list:
        out = [as_dict(s) for s in self.to_split_dict()]
    ...
    @classmethod
    def from_yaml_list(cls, yaml_data: list) -> "SplitDict":
