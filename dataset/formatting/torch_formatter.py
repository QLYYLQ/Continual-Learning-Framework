...
import CLTrainingFramework.dataset.utils.package_config as config
from CLTrainingFramework.dataset.utils.py_utils_mine import map_nested
from CLTrainingFramework.dataset.formatting import TensorFormatter
...
class TorchFormatter(TensorFormatter[Mapping, "torch.Tensor", Mapping]):
    def __init__(self, schema=None, token_per_repo_id=None, **torch_tensor_kwargs):
